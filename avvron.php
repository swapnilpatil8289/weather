...
<p align="center"><h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style1">&nbsp;&nbsp;<a href="http://avvron.com">Home</a></span></h2>
</p>
   </div>
</div>
...
$query1 = "SELECT date, max(temperature) as temp_max, min(temperature) as as temp_min ,max(\"Humitdity\") as max_hum ,min(\"Humitdity\") as min_hum  FROM processed_data where date = (select max(date) from processed_data where stationid = '80') and stationid = '80' group by date;";; 
...
echo("Solarradiation   - ".$myrow['Solarradiation']."  W/m2");
 ...
 while($myrow1 = pg_fetch_assoc($result1)) { 
			     $max_temp =  $myrow1['temp_max'];
				  $min_temp =  $myrow1['temp_min'];
				  $max_hum =  $myrow1['hum_max'];
				  $min_temp =  $myrow1['hum_min'];
				  echo("Temperature (Max)  - ".$myrow1['temp_max']."  C");
				  echo("Temperature (Min) - ".$myrow1['temp_min']."  C");
				  echo("Humidity(Max)  - ".$myrow1['hum_max']."  %");
				  echo("Humidity(Min) - ".$myrow1['hum_min']."  %");
